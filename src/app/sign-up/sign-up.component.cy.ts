...
describe(SignUpComponent.name, () => {
  ...
  it('submit button should disabled when password has fewer than 8 chars', () => {
    cy.get('[data-cy="first-name"]').type('Rik');
    cy.get('[data-cy="last-name"]').type('Toetenel');
    cy.get('[data-cy="email"]').type('riktoet@gmail.com');
  ...
  it('submit button should disabled when password has only uppercase chars', () => {
    cy.get('[data-cy="first-name"]').type('Rik');
    cy.get('[data-cy="last-name"]').type('Toetenel');
    cy.get('[data-cy="email"]').type('riktoet@gmail.com');
  ...
  it('submit button should disabled when password has the first name in it', () => {
    cy.get('[data-cy="first-name"]').type('Rik');
    cy.get('[data-cy="last-name"]').type('Toetenel');
    cy.get('[data-cy="email"]').type('riktoet@gmail.com');
  ...
  it('submit button should disabled when password has the first and last name in it', () => {
    cy.get('[data-cy="first-name"]').type('Rik');
    cy.get('[data-cy="last-name"]').type('Toetenel');
    cy.get('[data-cy="email"]').type('riktoet@gmail.com');
  ...
  it('submit button should disabled first when password has the first and last name in it, but when you later edit the names it will be not be disabled', () => {
    cy.get('[data-cy="first-name"]').type('Rik');
    cy.get('[data-cy="last-name"]').type('Toetenel');
    cy.get('[data-cy="email"]').type('riktoet@gmail.com');
    cy.get('[data-cy="password"]').type('RikToetenelPassword');
